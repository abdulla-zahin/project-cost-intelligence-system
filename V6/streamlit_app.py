...
def create_excel_report(
    ...
    allocation_status = (
        "Balanced" if total_allocation_pct == 100 else "Under Allocated" if total_allocation_pct < 100 else "Over Allocated"
    )
    ...
    with pd.ExcelWriter(output, engine="openpyxl") as writer:
        ...
        for col, width in {"A": 24, "B": 24, "C": 24, "D": 24, "E": 24, "F": 24}.items():
        ...
        ws["A13"] = "EXECUTIVE NOTE"
        ws["A13"].fill = mid_fill
        ...
        for cell in ["A3", "B3", "A4", "B4", "A5", "B5", "A6", "B6"]:
...
st.success("Project Cost Intelligence System is ready for estimation, analysis, reporting, and Excel export.")
