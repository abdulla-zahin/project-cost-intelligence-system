...
def create_excel_report(project_name: str, company_name: str, author_name: str, today: str, total_budget: float, allocations: dict, df: pd.DataFrame, insights: list[str]) -> BytesIO:
    output = BytesIO()
