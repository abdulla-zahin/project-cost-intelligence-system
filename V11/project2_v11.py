...
st.title("🏗️ Project Cost Intelligence System - V11")
...
st.caption("Upload a BOQ in CSV or XLSX format. V10 supports smart column matching such as Item/Description, Quantity/Qty, Unit Cost/Rate, and Category/Type.")
...
st.success("Version 11 completed with BOQ integration, export support, and auto-reset project defaults.")
