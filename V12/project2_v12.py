...
st.title("🏗️ Project Cost Intelligence System - V12")
...
st.info("V12 adds a cleaner UI, a BOQ template download, and keeps the richer V10 reporting engine intact.")
...
st.caption("Upload a BOQ in CSV or XLSX format. V12 supports smart column matching such as Item/Description, Quantity/Qty, Unit Cost/Rate, and Category/Type.")
...
st.success("Version 12 completed with polished UI improvements, template download, BOQ integration, export support, and auto-reset project defaults.")
